...
def _build_parser() -> argparse.ArgumentParser:
    ...
    feed.add_argument("--exclude_sources", default="")
    feed.add_argument("--min_score", type=int, default=0)
    feed.add_argument("--new_only", action="store_true")
    feed.add_argument("--max_age_hours", type=int)
